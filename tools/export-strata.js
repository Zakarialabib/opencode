...
if (fs.existsSync(skillsDir)) {
    activeSkills = fs.readdirSync(skillsDir).filter(file => fs.statSync(path.join(skillsDir, file)).isDirectory());
}
...
const strata = {
    ...
    memoryPointers: [
        'C:\\opencode\\database.sqlite',
        'C:\\opencode\\.opencode\\memory.jsonl'
    ]
};
