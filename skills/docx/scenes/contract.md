...
new Paragraph({
  ...
  children: [
    new TextRun({
      text: "Training Cooperation Framework Agreement",
      size: 44,
      bold: true,
      color: "000000", // ← MUST be "000000"
...
function partyInfoBlock(partyLabel, partyName, fields) {
  ...
  const headerPara = new Paragraph({
    ...
    children: [
      new TextRun({
        text: `${partyLabel}: ${safeText(partyName, "【Company full name】")}`,
        size: 24,
...
function buildSignatureBlock(partyA, partyB) {
  const fields = [
    "Party (Seal)",
    "Legal Rep / Authorized Rep (Signature)",
    "Contact Person",
    "Contact Info",
    "Signing Location",
    "Date",
      ...
      return new TableRow({
        children: [
          new TableCell({
            ...
            children: [
              new Paragraph({
                children: [new TextRun({ text: displayA, size: 24, color: "000000" })],
              }),
            ],
          }),
          new TableCell({
            ...
            children: [
              new Paragraph({
                children: [new TextRun({ text: displayB, size: 24, color: "000000" })],
              }),
            ],
          }),
        ],
